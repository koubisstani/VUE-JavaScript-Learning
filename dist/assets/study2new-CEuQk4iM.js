import{M as u,a as m,S as f}from"./StudyContent-BPr2YxYz.js";import{c as i}from"./codeItem-Cy0TIWKK.js";import{M as h}from"./MyTitle-Ch0XEo59.js";import{_ as w,n as x,f as b,o as C,c as B,w as n,a as t,b as s,d as a}from"./index-DMEq0VNs.js";const _={class:"choices"},E={components:{"my-title":h,"my-footer":m,"my-container":u,"study-content":f,"code-item":i}},I=Object.assign(E,{__name:"study2new",setup(S){return x(()=>{const o=document.getElementById("robotCanvas"),e=o.getContext("2d");let r=o.width/2,d=o.height/2,v=20,p="blue";function c(){e.clearRect(0,0,o.width,o.height),e.beginPath(),e.arc(r,d,v,0,Math.PI*2),e.fillStyle=p,e.fill(),e.closePath()}function y(l){const g=document.getElementById("codeDisplay");g.textContent=`
