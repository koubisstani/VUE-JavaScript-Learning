import{M as v,a as m,S as w}from"./StudyContent-DmgqnPrB.js";import{c as u}from"./codeItem-BKQqYzK7.js";import{M as f}from"./MyTitle-BnWlqeve.js";import{_ as b,a as x}from"./demoCode-Ct16FRVs.js";import{_ as k,n as T,f as p,o as I,c as M,w as a,a as e,b as r,d as o}from"./index-NwAmraC0.js";const C={components:{"my-title":f,"my-footer":m,"my-container":v,"study-content":w,"code-item":u,"my-demo":b,"demo-code":x}},D=Object.assign(C,{__name:"study2new",setup(B){return T(()=>{const c=document.getElementById("robotCanvas"),t=c.getContext("2d");c.width/2,c.height/2;function h(){const n=document.getElementById("codeDisplay");n.textContent=`
    function draw1() {
    ctx.beginPath()
    var x = 500
    var y = 250
