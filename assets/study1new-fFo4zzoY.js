import{M as y,a as m,S as p}from"./StudyContent-DmgqnPrB.js";import{c as r}from"./codeItem-BKQqYzK7.js";import{M as f}from"./MyTitle-BnWlqeve.js";import{_ as v,n as g,f as x,o as k,c as C,w as o,a as e,b as a,d as s}from"./index-NwAmraC0.js";const B={class:"choices"},I={components:{"my-title":f,"my-footer":m,"my-container":y,"study-content":p,"code-item":r}},E=Object.assign(I,{__name:"study1new",setup(S){return g(()=>{const n=document.getElementById("robotCanvas"),t=n.getContext("2d");let d=n.width/2,i=n.height/2,w=20,h="blue";function u(){t.clearRect(0,0,n.width,n.height),t.beginPath(),t.arc(d,i,w,0,Math.PI*2),t.fillStyle=h,t.fill(),t.closePath()}function b(c){const l=document.getElementById("codeDisplay");l.textContent=`
